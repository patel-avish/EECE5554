clc;
clear;
path = "C:\Users\AVISH\OneDrive\Desktop\Data_Lab3\LocationB\vectornav.csv";
[time,x,y,z] = extractdata(path);
fs = 20; % the data is sampled at 20Hz

% Plot gyro x,y,z vs time
figure();
sgtitle("LocationB Gyro x, y, z vs. Time (Fig 5)");
subplot(2,2,1);
plotvstime(x,time)
...
% Plot gyro x,y,z vs time
figure();
sgtitle("LocationB Allan variance plots for gyro x, y, z (Fig 4)");
subplot(2,2,1);
