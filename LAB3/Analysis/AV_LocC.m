clc;
clear;
path = "C:\Users\AVISH\OneDrive\Desktop\Data_Lab3\LocationC\vectornav.csv";
[time,x,y,z] = extractdata(path);
fs = 40; % the data is sampled at 40Hz

% Plot gyro x,y,z vs time
figure();
sgtitle("LocationC Gyro x, y, z vs. Time (Fig 5)");
subplot(2,2,1);
plotvstime(x,time)
...
% Plot gyro x,y,z vs time
figure();
sgtitle("LocationC Allan variance plots for gyro x, y, z (Fig 4)");
subplot(2,2,1);
