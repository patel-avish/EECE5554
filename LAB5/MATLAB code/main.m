...
% Load images.
directory = fullfile("C:\Users\AVISH\OneDrive\Desktop\LAB5\Data\Brick Wall");
scene = imageDatastore(directory);


% Display images to be stitched.
figure();
montage(scene.Files)
%title('Image Data Set')
%% Harris Corner Detections and Feature Matching
...
[y,x,m] = harris(grayImage,N,'tile',window,'disp');
%[y,x,m] = harris(grayImage,N,'tile',[2 2],'disp','hsize',50,'sigma',50);
...
%% Mosiacing Output Space Generation
